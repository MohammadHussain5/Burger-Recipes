...
while (condition) {
    const input = await inquirer.prompt([
        {
            name: "recipes",
            type: "list",
            message: chalk.yellow.bold("Which type of burger would you like to make?"),
            choices: [
                "Zinger Burger",
                "Cheese Burger",
                "Veggie Burger",
    ...
    let condition1 = await inquirer.prompt({
        name: "again",
        type: "confirm",
        message: chalk.yellowBright.bold("Would you like to see any other recipes?"),
        default: false,
    });
